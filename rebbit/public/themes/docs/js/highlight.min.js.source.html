...
<html>
<head>
    <title>PHPXRef 0.7.1 : Unnamed Project : /public/themes/docs/js/highlight.min.js source</title>
...
ext='.html';
relbase='../../../../';
subdir='public/themes/docs/js';
filename='highlight.min.js.source.html';
cookiekey='phpxref';
...
'match': ['match', 'Attempts to match all patterns at once against a string. ', [['tests/simpletest','php_parser.php',62]], 48],
...
'z': ['z', '', [['public/themes/admin/js','jquery.dataTables.min.js',62]], 28],
...
'script': ['script', 'Script Tag ', [['bonfire/codeigniter/libraries/javascript','Jquery.php',1004]], 2],
'substr': ['substr', '', [], 239],
'exec': ['exec', '', [], 114],
'split': ['split', '', [], 153]};
CLASS_DATA={
